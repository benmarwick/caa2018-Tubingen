...
The use of R is on the rise among archaeologists using natural and physical science methods, and has concrete advantages for authors that publish papers that cite R as they tend to be referenced more often. This also is an indicator for the increase in popularity of R. 

The use of R or any other scripting languages enables a paradigm-shift, as it offers the possibility to share one's code. The sharing of code has been identified in other disciplines as an amplifier of methodological change [@touchon_and_mccoy_2016]. It also enables researchers to not just reproduce the work of others, but to also evaluate them according to the scientific method. Thus, the sharing of code may be at the root of a tool-driven paradigm-change as desribed in the work of @Galison_1997. 

Speaking with Kuhn's view on paradigm-change, a change in the view point of researchers is necessary. We propose that a change of point of view of the archaeological researcher is needed: She or he, who works with computational methods, needs to view him/herself as a scientist, who needs to adhere to the scientific method, i. e. making the research reproducible for others. 

...
There is an argument among philosophers of science that revolutions in science are either ideas-driven or tool-driven. One of the most widely-known models of ideas-driven change in science is Kuhn's [-@Kuhn_1962] concept of a paradigm shift. In brief, this model proposes that the history of science consists of long periods of 'normal science' punctuated by short episodes of revolution. Normal science was described by Kuhn as routine day-to-day research focused on 'puzzle solving.' Revolutions in science occur when anomalous observations culminate in changes that replace one paradigm with another. 

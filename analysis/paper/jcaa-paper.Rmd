...
#  scale_y_continuous(labels = scales::percent) +
  ...
  ylab("Number of Articles in that journal in that year") +
  theme_minimal() +
...
ggplot(archy_cran_cites_all_areas_top_journals_by_year,
  ...
  #scale_y_continuous(labels = scales::percent,
   #                  limits = c(0, 0.2)) +
  xlab("Publication year") +
  ylab("Number of articles in that journal")
...
all_archaeology_citing_R_over_time  +
  annotation_custom(grob = ggplotGrob(jas_cites_r), 
                          xmin = 2030, xmax = 2040, 
                          ymin = 12, ymax = 17) # changed position because of numbers now instead of percentage

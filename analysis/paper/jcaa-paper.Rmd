...
ggplot(cran_cites_all_areas_top_journals_by_year,
  ...
  geom_text_repel(
   ...
   scale_x_continuous(breaks = min_y:max_y,
                     labels = c(min_y:2017rep, rep("", length(2018:max_y))),
...
all_archaeology_citing_R_over_time  +
  annotation_custom(grob = ggplotGrob(jas_cites_r), 
                          xmin = 2030, xmax = 2050, 
                          ymin = 1.2, ymax = 2.6) # changed position because of numbers now instead of percentage + logarithmic scale in bigger plot

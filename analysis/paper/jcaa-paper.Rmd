...
```{r ecology-articles-citing-r-plot, fig.cap=str_glue('Number of articles per year citing R in top Ecology journals ({prettyNum(articles_shown_in_plot,",")} articles out of {prettyNum(how_many_articles_in_top_journals_for_cran_cites,",")}). Data from Web of Science for 2007-2017')}
min_y <- 2007
max_y <- 2025

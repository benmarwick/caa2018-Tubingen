...
Here is a real-world example R Markdown in use, from an archaeology article published earlier this year. 
...
Here is the file structure the rrtools gives us. There isn't time here to discuss it in detail, except to point out two important principles that it enforces:
...
The rrtools project was developed during the 2017 Summer School on Reproducible Research in Landscape Archaeology at the Freie Universität Berlin (17-21 July), funded and jointly organized by Exc264 Topoi, CRC1266, and ISAAKiel. 

Thanks to Daniel Knitter, Patrick Kennedy, Nils Müller-Scheeßel, Martin Hinz, Clemens Schmid, Ricarda Braun, Wojciech Francuzik for their contributions to the package.

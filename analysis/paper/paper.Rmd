...
We would now like to focus on a small sub-set of these papers using R, because they are doing something very interesting that we think all archaeologists using a programming language should be doing. This subset of papers are demonstrating the potential of R for open and reproducible research. 
